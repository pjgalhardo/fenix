...
public class InteractionUsingApplet extends JApplet implements Interaction {
   ...
   * <b>mainClass</B> parameter, builds the <code>main()</code> arguments from the
   * <b>mainArgs</b> parameter and calls the application's main rotine:
   * <b>mainClass.main(mainArgs)</b>. The <b>AppletInteraction</b> is then called
   * back by the <b>UserInteraction</b>.
   */
  private void main() {
  ...
  public class AppletPanel extends JPanel implements ActionListener {
    ...
    /**
     * implements ActionListener is called when a menu option is selected or when th
     * OK button is pressed is Forms or messages.
     * 
    ...
    /**
     * Wait until the OK button is pressed and the <b>_end</b> becomes <b>true</b>
     */
    ...
    AppletPanel(Menu m) {
      ...
      int[] key = { KeyEvent.VK_1, KeyEvent.VK_2, KeyEvent.VK_3, KeyEvent.VK_4, KeyEvent.VK_5, KeyEvent.VK_6,
